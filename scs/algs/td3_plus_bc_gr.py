...
from scs.algs.torch.td3_plus_bc_gr_impl import TD3PlusBCgRImpl
...
__all__ = ["TD3PlusBCgR", "TD3PlusBCgRConfig"]


@dataclasses.dataclass()
class TD3PlusBCgRConfig(LearnableConfig):
    r"""Config of TD3+BC algorithm with gated regularization.
    ...
    def create(
        ...
        return TD3PlusBCgR(self, device, enable_ddp)

    @staticmethod
    def get_type() -> str:
        return "td3_plus_bc_gr"


class TD3PlusBCgR(QLearningAlgoBase[TD3PlusBCgRImpl, TD3PlusBCgRConfig]):
...
register_learnable(TD3PlusBCgRConfig)
