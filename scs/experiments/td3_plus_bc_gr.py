...
from scs.algs.td3_plus_bc_gr import TD3PlusBCgRConfig
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run TD3+BCgR experiment")
    ...
    td3bcgr.fit(
        ...
        experiment_name=f"TD3PlusBCgR_{args.gate_weight}_{args.dataset}_{args.seed}",
    )
