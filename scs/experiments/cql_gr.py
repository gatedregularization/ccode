...
from scs.algs.cql_gr import CQLgRConfig
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run CQLgR experiment")
    ...
    cqlgr.fit(
        ...
        experiment_name=f"CQLgR_{args.gate_weight}_{args.dataset}_{args.seed}",
    )
