...
from scs.algs.rebrac_gr import ReBRACgRConfig
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ReBRACgR experiment")
    ...
    rebracgr.fit(
        ...
        experiment_name=f"ReBRACgR_{args.gate_weight}_{args.dataset}_{args.seed}",
    )
